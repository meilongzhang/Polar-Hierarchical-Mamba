...
- [ ] Merge PFCF to [OpenPCDet](https://github.com/open-mmlab/OpenPCDet).

## Acknowledgments
PFCF and PHiM are based on [OpenPCDet](https://github.com/open-mmlab/OpenPCDet) and [Voxel Mamba]([https://github.com/gwenzhang/Voxel-Mamba]).  
